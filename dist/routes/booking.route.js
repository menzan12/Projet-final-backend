...
const createBookingMiddleware_1 = require("../middlewares/createBookingMiddleware");
const router = express_1.default.Router();
router.post("/create", createBookingMiddleware_1.checkBody, bookingController_1.createBooking);
