...
const getVendorStats = async (req, res) => {
    try {
        ...
        ===================================================== */
        const lastMonthResult = await Booking_model_1.default.aggregate([
            {
                $match: {
                    vendor: new mongoose_1.Types.ObjectId(vendorId),
                    status: "completed",
        ...
        ===================================================== */
        const pendingServices = await Service_model_1.default.countDocuments({
            vendor: new mongoose_1.Types.ObjectId(vendorId),
            status: "pending",
        });
        /* =====================================================
